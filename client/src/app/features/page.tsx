    ...
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-lime-300 via-electric-green-400 to-lime-200 py-24 md:py-32">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-3xl md:text-3xl lg:text-3xl font-bbh-bartle uppercase tracking-tight text-slate-900 mb-8 drop-shadow-2xl animate-pulse-glow">
            Powerful Features
          </h1>
          <p className="text-lg md:text-lg font-dm-sans text-slate-800 max-w-5xl mx-auto">
            ...
            <div className="order-2 md:order-1">
              <div className="flex items-center gap-6 mb-8">
                <div className="p-4 bg-lime-500/30 rounded-2xl animate-pulse-glow-icon">
                  <Search className="h-7 w-7 text-lime-700" />
                </div>
                <h3 className="text-3xl font-bbh-bartle text-slate-900">Lightning-Fast Search</h3>
              </div>
              <p className="text-lg font-dm-sans text-slate-800 mb-4">
                Instant fuzzy search across millions of movies, actors, directors, and genres.
              </p>
              <ul className="space-y-3 text-lg font-dm-sans text-slate-700">
            ...
            <div>
              <div className="flex items-center gap-6 mb-8">
                <div className="p-4 bg-emerald-500/30 rounded-2xl animate-pulse-glow-icon">
                  <Film className="h-7 w-7 text-emerald-700" />
                </div>
                <h3 className="text-3xl font-bbh-bartle text-slate-900">Rich Movie Profiles</h3>
              </div>
              <p className="text-lg font-dm-sans text-slate-800 mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center mb-32">
            <div className="order-2 md:order-1">
              <div className="flex items-center gap-6 mb-8">
                ...
                <h3 className="text-3xl font-bbh-bartle text-slate-900">Personal Watchlists & Favorites</h3>
              </div>
              <p className="text-lg font-dm-sans text-slate-800 mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              <div className="flex items-center gap-6 mb-8">
                ...
                <h3 className="text-3xl font-bbh-bartle text-slate-900">Enterprise-Grade Security & Multi-Tenant</h3>
              </div>
              <p className="text-lg font-dm-sans text-slate-800 mb-8">
      ...
      <section className="py-24 bg-gradient-to-br from-electric-green-400 to-lime-300">
        <div className="max-w-4xl mx-auto text-center px-4">
          <h2 className="text-3xl md:text-4xl font-bbh-bartle uppercase text-slate-900 mb-8 drop-shadow-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            <Button asChild size="lg" variant="outline" className="bg-transparent text-slate-900 border-2 border-slate-900 hover:bg-slate-900 hover:text-white font-bold text-xl px-10 py-7 backdrop-blur-sm">
