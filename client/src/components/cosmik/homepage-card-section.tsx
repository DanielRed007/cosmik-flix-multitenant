    ...
    <section className="py-24 bg-gradient-to-br from-lime-400 via-electric-green-700 to-lime-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bbh-bartle uppercase tracking-tight text-slate-900 mb-6 drop-shadow-lg">
            Why Choose Cosmik?
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="bg-white/70 backdrop-blur-md border border-white/30 rounded-3xl p-10 hover:bg-white/90 hover:border-lime-400 transition-all duration-500 hover:-translate-y-4 hover:shadow-2xl hover:shadow-lime-500/40">
            <div className="w-20 h-20 bg-lime-500/20 rounded-2xl flex items-center justify-center mb-8 animate-pulse-glow-icon">
              <svg className="w-10 h-10 text-lime-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
            </div>
            <h3 className="text-2xl font-bbh-bartle text-slate-900 mb-4">
              Lightning Fast
            </h3>
            <p className="text-lg font-dm-sans text-slate-700 leading-relaxed">
          ...
          {/* Card 2 */}
          <div className="bg-white/70 backdrop-blur-md border border-white/30 rounded-3xl p-10 hover:bg-white/90 hover:border-lime-400 transition-all duration-500 hover:-translate-y-4 hover:shadow-2xl hover:shadow-lime-500/40">
            <div className="w-20 h-20 bg-emerald-500/20 rounded-2xl flex items-center justify-center mb-8 animate-pulse-glow-icon">
          ...
          {/* Card 3 */}
          <div className="bg-white/70 backdrop-blur-md border border-white/30 rounded-3xl p-10 hover:bg-white/90 hover:border-lime-400 transition-all duration-500 hover:-translate-y-4 hover:shadow-2xl hover:shadow-lime-500/40">
            <div className="w-20 h-20 bg-teal-500/20 rounded-2xl flex items-center justify-center mb-8 animate-pulse-glow-icon">
